...
<body>
    ...
    <div class ="center">
        ...
        <a href ="Equipment-Create.php" class="createEquipmentRef">Add Equipment</a><br>
            ...
            if(mysqli_num_rows($result) > 0){
                    ...
                    while($row = mysqli_fetch_array($result)){
                        ...
                        echo "<br>";
                            ...
                            echo "<a href='Equipment-Update.php?serial_number=" . $row['serial_number'] . "'>Edit</a><br>";
                            echo "<a data-toggle='modal' href='Equipment-Delete.php?serial_number=" . $row['serial_number'] . "' data-target='#deleteModal'>Delete<br></a>";
